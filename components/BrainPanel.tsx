...
export default function BrainPanel({ mode }: BrainPanelProps) {
  return (
    <div className="flex-[0_0_32%] h-full gradient-brain-bg rounded-3xl border border-border-soft/30 shadow-2xl flex items-center justify-center p-12 relative overflow-hidden">
